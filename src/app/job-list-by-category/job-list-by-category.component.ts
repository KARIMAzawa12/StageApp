...
@Component({
  selector: 'app-job-list-by-category',
  templateUrl: './job-list-by-category.component.html',
  styleUrls: ['./job-list-by-category.component.css']
})
export class JobListByCategoryComponent implements OnInit {
